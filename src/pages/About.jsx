...
export default function About() {
  ...
  paragraph2:
    ...
    中文: {
     journey: "我的旅程",
  paragraph1:
    "七年前，我踏上了在中国的新旅程 个充满历史、创新与温度的国度。最初的好奇，逐渐变成了与人们、文化和日常生活之间深厚的情感纽带。通过我的优兔频道，我记录并分享中国的真实故事，展现传统、美食、节日和日常生活的独特魅力。",
  paragraph2:
  ...
  return (
    <div id="about" className="about-page">  {/* ✅ ID ADDED HERE */}
